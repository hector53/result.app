    ...
    <div id="modalAddEncuestaLive" class="modal">
      ...
      <div class="modal-content">
        <div class="box" style="text-align: left">
          ...
          <sorteo-add-modal
            @cerrarModal="cerrarModalEncuestaActiva"
            v-if="encuestaActive == 3"
          ></sorteo-add-modal>

          <dia-hora-add-modal
            @cerrarModal="cerrarModalEncuestaActiva"
            v-if="encuestaActive == 4"
          ></dia-hora-add-modal>

          <qya-add-modal
            @cerrarModal="cerrarModalEncuestaActiva"
            v-if="encuestaActive == 5"
          ></qya-add-modal>
        </div>
      </div>
      <button
    ...
    <div class="cubreNavBarPresentacion">
      <div class="navBarLeft">
        <ul role="list" class="listNavBarLeft">
          <li
            class="list-item-navLeft add"
            title="Agregar Encuesta"
            alt="Agregar Encuesta"
          >
              ...
              >
                <div class="dropdown-content liveNew">
                  ...
                  <a class="dropdown-item" @click="openModalAddLive(2)">
                    <i class="fa fa-cloud mr-3" aria-hidden="true"></i>
          ...
          <li
            class="list-item-navLeft stop"
            v-else
            @click="activarEvento(2)"
            title="Detener Presentación"
            alt="Detener Presentación"
          >
            <img
...
export default {
  ...
  methods: {
    ...
    async selectActiveEncuesta(id) {
      ...
      await this.$axios
        .$post("modo_live_evento_encuesta_activa", {
          id: id,
          codigo: this.$route.params.cod,
        })
        .then((response) => {

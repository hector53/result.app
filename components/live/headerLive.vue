    ...
    <div class="cubreNavBarPresentacion">
      <div class="navBarLeft">
        <ul role="list" class="listNavBarLeft">
          <li class="list-item-navLeft add">
 <div class="dropdown is-hoverable" 
             >
                            <div class="dropdown-trigger">
                                <div class="cubreIconDropdown">
                                  <i class="fa fa-plus" aria-hidden="true"   style="    font-size: 35px;"></i>
                                </div>
                            </div>
          ...
          <li class="list-item-navLeft stop " v-else @click="activarEvento(2)">
            <img
          ...
          <li class="list-item-navLeft candado" @click="cambiarStatus">
            
            <i class="fa fa-unlock" v-if="$store.state.candadoModoLive==1"   style="    font-size: 35px;" aria-hidden="true" ></i>
             <i class="fa fa-lock" v-else aria-hidden="true" style="    font-size: 35px;"></i>
           
          </li>

          <li class="list-item-navLeft tareas">
      ...
      <div class="navBarLeft">
        <ul role="list" class="listNavBarLeft">
          <li class="list-item-navLeft config">
            <img
              src="data:image/png;base64,"
              loading="lazy"
              alt=""
              class="imageNarBar"
            />
          ...
          <li class="list-item-navLeft config" @click="activarFullScreen">
            <img
...
async deleteEncuestaById(id){
 ...
 async   selectActiveEncuesta(id){
      ...
      const response = await this.$axios.$post("modo_live_evento_encuesta_activa", {
          id: id, 
          codigo: this.$route.params.cod
          });

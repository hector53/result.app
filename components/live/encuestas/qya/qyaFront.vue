        ...
        <div class="item_pregunta_top">
          ...
          <div class="item_pregunta_top_like">
            ...
            <span class="icontree" v-if="$store.state.p == item.id_user">
              ...
              ></i>
              &nbsp;&nbsp;
              <i class="fa fa-trash iconEditQyA" @click="deletePregunta(item)" aria-hidden="true"></i>
            </span>
          </div>
        </div>
  ...
  methods: {
      ...
      async likePregunta(id){
        if(this.statusEvent == 1){
                  ...
                  const response = await this.$axios.$post("like_encuesta_qya_front", {
        qya: id,
     ...
     replyPregunta(item){
      ...
      async deletePreguntaById(id){
          ...
          const response = await this.$axios.$post("delete_qya_live_user", {
        id_evento: this.id_evento,
        id_encuesta: this.id_encuesta,
        p: this.$store.state.p,
        codigo: this.$route.params.cod,
    ...
    async guardarEditPregunta() {
      ...
      const response = await this.$axios.$post("edit_qya_live_front", {

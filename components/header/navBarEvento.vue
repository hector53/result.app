            ...
            <nav class="navbar" role="navigation" aria-label="main navigation">
                ...
                <div class="navbar-menu is-hidden-desktop menuPhone " :class="{'dBlock': navBar}" >
                    ...
                    <div class="navbar-item">
                        <button class="button is-info play " @click="activarEvento(1)" v-if="modoLive == 0">
                        <i class="fa fa-play" aria-hidden="true"></i>
                        </button>
                      
                       <button class="button  stop " @click="activarEvento(2)" v-if="modoLive == 1">
                       <img
            ...
            />
                        ...
                        <div class="dropdown is-hoverable" :class="{'is-active': dropdownPublicar }" style="    margin-left: 10px;">
                            ...
                            <i class="fa fa-caret-down" aria-hidden="true"></i>
                                ...
                                <hr class="dropdown-divider">
                                <a @click="Presentar" class="dropdown-item">
                                Presentación
                                </a>
                                </div>
                                </div>
                            ...
                            <div class="navbar-item is-hidden-desktop" v-if="$store.state.login">
                                ...
                                <a @click="logout"  class="button is-light is-fullwidth title is-5">{{$store.state.idioma.salirTitle}}</a>
                            </div>
